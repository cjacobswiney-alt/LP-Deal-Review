...
- Calculate net sponsor exposure on every deal (one-time fees only).
...
Calculate net sponsor exposure (co-invest minus one-time transaction fees only — acquisition fee, disposition fee). Do NOT net ongoing fees (property management, asset management) against co-invest — these are recurring operating/oversight fees, not upfront capital extractions. However, flag asset management fees if they exceed the 1-2% market benchmark. Compare one-time fees to benchmarks (10% co-invest, 1-2% acquisition, 20-30% promote). Flag if one-time transaction fees exceed co-invest. Evaluate waterfall structure, pref mechanics, and clawback. Max 5 questions.

### Underwriting & Assumptions
Note which assumptions appear reasonable and market-supported. For the 2-3 assumptions that need independent verification, explain what to check and how (specific comp pull or data request). Max 4 questions.
